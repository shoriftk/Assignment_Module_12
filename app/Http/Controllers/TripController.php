...
class TripController extends Controller
{
    ...
    public function index()
    {
        ...
        $availableSeats = Trip::sum('available_ticket');
        $totalUsers = User::count();
        $soldTicket = SeatAllocation::sum('quantity');
        $totalTickets = SeatAllocation::sum('quantity');
        $location = Location::count();

        return view('pages.index', compact('totalTrips', 'totalUsers','totalTickets', 'availableSeats', 'soldTicket', 'location',));
    }
